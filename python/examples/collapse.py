...
#   PYTHONPATH=build/python python3 python/examples/collapse.py
...
# silently be lost - always assign the whole vector at once, which invokes the real setter.
...
box_L = [0.2, 0.2]
box_c = [1, 0.1]
box_v = [0, 0]       # Imposed velocity of object
