...
template <typename S>
#ifdef THREEDIM
void regularSampleParticlesFromVdb(S& sim, std::vector<ObjectVdb> objects, T ppc = 8)
#else
void regularSampleParticlesFromVdb(S& sim, std::vector<ObjectVdb> objects, T ppc = 4)
#endif
{
