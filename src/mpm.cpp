...
int main(){
    ...
    #ifdef THREEDIM
        ObjectPlate sideback  = ObjectPlate(-0.5*sim.Lz, back,  SLIPFREE);  sim.plates.push_back(sideback);
        ObjectPlate sidefront = ObjectPlate( 0.5*sim.Lz, front, SLIPFREE);  sim.plates.push_back(sidefront);
    #endif
